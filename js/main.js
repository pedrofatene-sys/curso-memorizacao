...
const channels = [
    { id: 'mx4KiRc6cdU', name: 'Palácio da Memória' },
    { id: '7N-4mfXFquA', name: 'Como Ter Uma Memória Fotográfica' },
    { id: 'X_HGFdtf6Uw', name: 'Como Superar a Perda da Memória Recente' },
    { id: 'AtiW-C8Apvs', name: 'Como lembrar do que Li' },
    { id: 'sZu5eoNjyH4', name: 'Como Estudar e Lembrar de Tudo' },
    { id: 'gBC7tb7fjlg', name: 'Como Lembrar do Que Estudei' },
    { id: 'EeYsBNn5Mdk', name: 'Como Melhorar Minha Memória' },
    { id: 'b_pqYpxyugM', name: 'Como Melhorar a Concentração' },
    { id: '_VYWI02FD0A', name: 'Como Aprender e Não Esquecer' },
    { id: 'NRsbHcjiSWw', name: 'Como Memorizar Mais Rápido)' },
    { id: 'QWGzak2NbGg', name: 'Como Lembrar de Algo que Esqueci' },
    { id: 'aQu8-rvIlU4', name: 'Como Encontrar Coisas Que Perdi' },
    { id: '0FKrL6n6xqQ', name: 'Como Memorizar Datas' },
    { id: '_qRIrhAC8oE', name: 'Como Memorizar Versículos da Bíblia' }
];
